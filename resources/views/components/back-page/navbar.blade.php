        ...
        <aside 
            ...
            <div class="absolute bottom-0 w-full p-4 border-t border-slate-800 bg-slate-900/50">
                <div class="flex items-center gap-3 px-2">
                    <img src="{{ asset(Auth::user()->profile_photo_path ?? 'https://ui-avatars.com/api/?name='.Auth::user()->name) }}" alt="" class="w-10 h-10 rounded-full flex items-center justify-center font-bold">
                    <div>
