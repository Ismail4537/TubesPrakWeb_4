    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="space-y-4 lg:col-start-3">
            ...
            <div class="relative w-full h-auto rounded-lg overflow-hidden shadow-xl">
               <img src="{{ $event['foto'] }}" alt="{{ $event['judul'] }}" class="w-full h-full object-cover">
        ...
        <div class="lg:col-span-2 lg:col-start-1 lg:row-start-1">
            ...
            <div class="space-y-4 mb-8">
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">{{ $event['alamat_lengkap'] }}</p>
                    </div>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <span class="font-semibold">{{ $event['tanggal'] }}</span>
                </div>
            </div>
            ...
            <div class="mt-6">
                <span class="inline-block bg-gray-200 text-gray-700 text-sm px-3 py-1 rounded-full">{{ $event['kategori'] }}</span>
            </div>
        </div>
