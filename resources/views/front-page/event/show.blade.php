            ...
            <div class="lg:col-span-2 lg:col-start-1 lg:row-start-1">
                ...
                <div class="space-y-4 mb-8">
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="font-semibold">{{ $event['start_date_time'] }} /
                ...
                <div class="mt-6">
                    <span
                        class="inline-block bg-gray-200 text-gray-700 text-sm px-3 py-1 rounded-full">{{ $event->category->name }}</span>
                </div>
                <br>
                <h2 class="text-2xl font-bold text-gray-900 mb-3 border-b pb-2">
                    ...
                    @else
                        ...
                        <div class="flex gap-5 items-center">
                            @foreach ($registrants as $registrant)
                                <div>
                                    <img src="{{ asset($registrant->user->profile_photo_path ?? 'https://ui-avatars.com/api/?name=' . $registrant->user->name) }}"
                                        alt=""
