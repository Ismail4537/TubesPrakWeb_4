    ...
    <div class="max-w-6xl mx-auto">
        <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
            <div class="flex flex-1 items-center gap-2 max-w-2xl">
                ...
                <div class="shrink-0">
                    <select class="block w-full pl-3 pr-8 py-2 text-sm bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 outline-none appearance-none cursor-pointer shadow-sm" 
            ...
            <div class="flex items-center justify-between px-6 py-4 bg-gray-50 border-t border-gray-200">
                <div class="hidden sm:flex flex-1 items-center">
                    <p class="text-sm text-gray-600">
                        Menampilkan <span class="font-medium">1</span> sampai <span class="font-medium">{{ count($listevent ?? []) }}</span> hasil
                    </p>
                </div>
                ...
                <div class="flex flex-1 justify-between sm:justify-end gap-2">
                    ...
                    <div class="hidden md:flex gap-1">
                        <button class="px-4 py-2 text-sm font-medium text-white bg-blue-500 border border-blue-500 rounded-lg">1</button>
                        <button class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50">2</button>
                    </div>
                    <button class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition">
                        Next
                    </button>
