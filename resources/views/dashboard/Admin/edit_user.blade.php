                    ...
                    <div
                        ...
                        <label for="image_upload" class="cursor-pointer">
                            <div id="placeholder-upload"
                                class="absolute inset-0 flex flex-col items-center justify-center p-6 text-center transition-opacity duration-300 {{ $user->photo ? 'hidden' : '' }}">
                            ...
                            <img id="preview-image"
                                class="absolute inset-0 w-full h-full object-cover {{ $user->profile_photo_path ? '' : 'hidden' }} z-10"
