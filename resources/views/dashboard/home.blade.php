        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-gray-900 mt-1">{{ $totalEvents }}</h3>
                </div>
            ...
            <div class="mt-4 flex items-center text-sm">
                <span class="text-purple-500 font-semibold">{{ $totalEventsScheduled }}</span>
                <span class="text-gray-400 ml-2">terjadwal</span>
            </div>
            <div class="mt-4 flex items-center text-sm">
                <span class="text-purple-500 font-semibold">{{ $totalEventsOngoing }}</span>
                <span class="text-gray-400 ml-2">berjalan</span>
            </div>
            <div class="mt-4 flex items-center text-sm">
                <span class="text-purple-500 font-semibold">{{ $totalEventsCompleted }}</span>
                <span class="text-gray-400 ml-2">selesai</span>
            </div>
            <div class="mt-4 flex items-center text-sm">
                <span class="text-purple-500 font-semibold">{{ $totalEventsCancelled }}</span>
