    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <nav class="flex justify-between items-center py-8">
            <div class="flex items-center">
                <span class="font-bold text-2xl text-indigo-600">Acarra</span>
            </div>
            <div>
                <a href="/login" class="text-sm font-semibold text-indigo-600 hover:text-indigo-500 transition">
