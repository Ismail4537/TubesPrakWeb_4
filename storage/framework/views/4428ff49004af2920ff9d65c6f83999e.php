 ...
 <?php $__env->slot('title', null, []); ?>  <?php echo e($title); ?>  <?php $__env->endSlot(); ?>
    ...
    <div class="relative flex items-center justify-center h-[350px] rounded-[10px] bg-center bg-no-repeat bg-cover overflow-hidden" 
        ...
        <div class="relative z-10 text-center px-4">
            ...
            <div class="mt-8">
                <a href="<?php echo e(route('event.index')); ?>" class="relative z-10 inline-block bg-blue-500 text-white font-bold py-2.5 px-5 rounded-[5px] no-underline transition-colors duration-300 ease-in-out hover:bg-blue-600">
                    Explore Events
                </a>
            </div>
        </div>
    </div>
    <div x-data="{ activeTab: 'Sorotan' }">
    
    <div class="pt-10 pb-2 px-7 bg-white font-sans" >
    ...
    <div>
        ...
        <div class="p-4 grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-4"> 
            <?php $__currentLoopData = $highlightEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a :class="activeTab === 'Sorotan' ? '' : 'hidden'" href="<?php echo e(route('event.show', ['slug' => $event->slug])); ?>" class="my-4 shrink-0 w-full">
                <div class="border border-gray-300 w-full max-w-xs bg-white rounded-xl shadow-lg overflow-hidden h-full flex flex-col">    
                    ...
                    <div class="relative h-32 sm:h-42"> 
                        <img src="<?php echo e(asset('../Image/Preview.jpg')); ?>" class="w-full h-full object-cover rounded-t-xl">
                    </div>
            ...
            <?php $__currentLoopData = $popularEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a :class="activeTab === 'Populer' ? '' : 'hidden'" href="<?php echo e(route('event.show', ['slug' => $event->slug])); ?>" class="my-4 shrink-0 w-full">
                <div class="border border-gray-300 w-full max-w-xs bg-white rounded-xl shadow-lg overflow-hidden h-full flex flex-col">    
            ...
            <?php $__currentLoopData = $latestEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a :class="activeTab === 'Terbaru' ? '' : 'hidden'" href="<?php echo e(route('event.show', ['slug' => $event->slug])); ?>" class="my-4 shrink-0 w-full">
                <div class="border border-gray-300 w-full max-w-xs bg-white rounded-xl shadow-lg overflow-hidden h-full flex flex-col">    
            ...
            <?php $__currentLoopData = $freeEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a :class="activeTab === 'Gratis' ? '' : 'hidden'" href="<?php echo e(route('event.show', ['slug' => $event->slug])); ?>" class="my-4 shrink-0 w-full">
                <div class="border border-gray-300 w-full max-w-xs bg-white rounded-xl shadow-lg overflow-hidden h-full flex flex-col">    
    ...
    <div class="px-4 mb-10">
        ...
        <div class="px-2 grid grid-cols-[repeat(auto-fit,minmax(177px,1fr))]">
            ...
            <a href="<?php echo e(route('contac.show', ['id' => $user->id])); ?>" class="my-4 shrink-0 w-48 ">
                <div class="p-2 flex flex-col items-center w-full max-w-xs rounded-xl overflow-hidden h-full">
                    <img src="<?php echo e(asset($user->profile_photo_path ?? 'https://ui-avatars.com/api/?name='.$user->name)); ?>" alt="gambar" class="w-35 h-35 rounded-full object-cover mb-4">
                    <h2 class="text-md font-medium text-gray-900 text-center"><?php echo e($user->name); ?></h2>
                </div>
            </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <a href="<?php echo e(route('contac')); ?>">
...
<?php endif; ?><?php /**PATH C:\Users\iafat\Herd\Acarra\resources\views/front-page/home.blade.php ENDPATH**/ ?>