    ...
    <div class="container mx-auto max-w-6xl px-4 py-6">
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-gray-600">Event: <span class="font-semibold"><?php echo e($event->title); ?></span></p>
            </div>
            <a href="<?php echo e(route('event.show', ['slug' => \Illuminate\Support\Str::slug($event->title)])); ?>"
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
            <div class="px-4 py-3 border-b border-gray-200 flex items-center justify-between">
                <p class="text-sm text-gray-700">Total: <span class="font-semibold"><?php echo e($registrants->count()); ?></span>
                </p>
            </div>
                            ...
                            <?php $__currentLoopData = $registrants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registrant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="px-4 py-3 text-sm text-gray-900">
                                        <a href="<?php echo e(route('contac.show', ['id' => $registrant->user->id])); ?>">
                                            <?php echo e($registrant->user?->name ?? 'Unknown'); ?>

                                        </a>
                                    </td>
                                    <td class="px-4 py-3 text-sm text-gray-700">
                                        <?php echo e($registrant->user?->email ?? '-'); ?>

                                    </td>
                                    <td class="px-4 py-3 text-sm text-gray-700">
                                        <?php echo e(optional($registrant->created_at)->format('d M Y, H:i')); ?>

                                    </td>
                                    <td class="px-4 py-3 text-right">
                                        <?php if($registrant->user): ?>
                                            <form
                                                action="<?php echo e(route('event.registrants.destroy', ['event' => $event->id, 'user' => $registrant->user->id])); ?>"
                                                method="POST"
...
<?php endif; ?>
<?php /**PATH C:\Users\iafat\Herd\Acarra\resources\views/front-page/event/registrants.blade.php ENDPATH**/ ?>