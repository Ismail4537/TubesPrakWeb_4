                    ...
                    <div class="w-full bg-gray-50 border-b border-gray-200 p-8 flex flex-col items-center text-center justify-center">
                        ...
                        <div class="relative mb-4 shrink-0">
                            <?php if(!empty($user->profile_photo_path)): ?>
                                <img src="<?php echo e(asset('storage/' . $user->profile_photo_path)); ?>" class="h-40 w-40 object-cover rounded-full border-4 border-white shadow-lg bg-gray-200">
                            <?php else: ?>
                        ...
                        <h4 class="font-bold text-gray-800 text-xl"><?php echo e(old('name', $user->name) ?? 'Nama User'); ?></h4>
...
<?php endif; ?><?php /**PATH C:\Users\iafat\Herd\Acarra\resources\views/front-page/user/edit.blade.php ENDPATH**/ ?>