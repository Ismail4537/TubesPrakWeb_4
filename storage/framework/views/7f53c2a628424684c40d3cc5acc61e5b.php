        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-10 lg:py-20">
            <div>
                <h1 class="text-4xl font-extrabold text-slate-900 sm:text-5xl md:text-6xl tracking-tight mb-6">
                    Tentang Acarra <br>
                    <span class="text-indigo-600">platform ticketing yang sederhana.</span>
                </h1>
                <p class="text-lg text-slate-500 mb-8 leading-relaxed">
                    Acarra membantu kamu menemukan event, mendaftar, dan melakukan pembayaran dengan aman. Untuk
                    penyelenggara,
                    Acarra memudahkan pembuatan event, pengelolaan kategori, dan pencatatan transaksi—semua dalam satu
                    tempat.
                </p>
            </div>
            <div class="relative">
    ...
    <div class="bg-slate-50 py-20 mt-10">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="text-base text-indigo-600 font-semibold tracking-wide uppercase">Misi Kami</h2>
                <p class="mt-2 text-3xl font-extrabold text-slate-900">Ticketing yang cepat, jelas, dan aman</p>
                <p class="mt-4 text-xl text-slate-500">
                    Kami berfokus pada pengalaman yang transparan—mulai dari detail event, proses registrasi, hingga
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                    ...
                    <h3 class="text-xl font-bold text-slate-900 mb-3">Transparan</h3>
                    <p class="text-slate-500">Info event, harga, dan status pembayaran ditampilkan jelas agar pengguna
                        yakin sebelum checkout.</p>
                </div>
                <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                    <div class="w-12 h-12 bg-indigo-100 rounded-lg flex items-center justify-center mb-6">
                        <span class="text-indigo-600 font-bold text-xl">2</span>
                    </div>
                    <h3 class="text-xl font-bold text-slate-900 mb-3">Praktis</h3>
                    <p class="text-slate-500">Daftar dan bayar dalam beberapa langkah, cocok untuk event gratis maupun
                        berbayar.</p>
                </div>
                <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                    <div class="w-12 h-12 bg-indigo-100 rounded-lg flex items-center justify-center mb-6">
                    ...
                    <h3 class="text-xl font-bold text-slate-900 mb-3">Aman</h3>
                    <p class="text-slate-500">Pembayaran diproses melalui gateway yang terpercaya, dan data transaksi
                        dicatat untuk kebutuhan pelaporan.</p>
                </div>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\iafat\Herd\Acarra\resources\views/front-page/about.blade.php ENDPATH**/ ?>