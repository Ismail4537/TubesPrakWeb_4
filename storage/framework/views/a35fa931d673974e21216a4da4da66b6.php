    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center text-sm">
            ...
            <div class="mb-4 md:mb-0">
                <p>&copy; <?php echo e(date('Y')); ?> Acarra. All Rights Reserved.</p>
            </div>
...
</footer><?php /**PATH C:\laragon\www\Acarra\resources\views/components/front-page/footer.blade.php ENDPATH**/ ?>