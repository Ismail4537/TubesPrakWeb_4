        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-gray-900 mt-1"><?php echo e($totalUsers); ?></h3>
                    <br>
                    <p class="text-sm font-medium text-gray-500 uppercase tracking-wider">Total Creator</p>
                    <h3 class="text-3xl font-bold text-gray-900 mt-1"><?php echo e($totalCreators); ?></h3>
                    <br>
                    <p class="text-sm font-medium text-gray-500 uppercase tracking-wider">Total Admin</p>
                    <h3 class="text-3xl font-bold text-gray-900 mt-1"><?php echo e($totalAdmins); ?></h3>
                </div>
                <div class="p-3 bg-blue-50 rounded-lg">
                    <svg class="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="Group-12 17l-4 4m0 0l-4-4m4 4V3" x-description="User Icon Placeholder"></path>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-gray-900 mt-1"><?php echo e($totalEvents); ?></h3>
                </div>
            ...
            <div class="mt-4 flex items-center text-sm">
                <span class="text-purple-500 font-semibold"><?php echo e($totalEventsScheduled); ?></span>
                <span class="text-gray-400 ml-2">terjadwal</span>
            </div>
            <div class="mt-4 flex items-center text-sm">
                <span class="text-purple-500 font-semibold"><?php echo e($totalEventsOngoing); ?></span>
                <span class="text-gray-400 ml-2">berjalan</span>
            </div>
            <div class="mt-4 flex items-center text-sm">
                <span class="text-purple-500 font-semibold"><?php echo e($totalEventsCompleted); ?></span>
                <span class="text-gray-400 ml-2">selesai</span>
            </div>
            <div class="mt-4 flex items-center text-sm">
                <span class="text-purple-500 font-semibold"><?php echo e($totalEventsCancelled); ?></span>
                <span class="text-gray-400 ml-2">dibatalkan</span>
            </div>
        </div>
    ...
    <div class="mt-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-linier-to-br from-blue-50 to-blue-100 rounded-xl shadow-sm p-6 border border-blue-200">
                ...
                <p class="text-sm text-gray-600 mb-4">Generate comprehensive PDF report of all registered users with
                    detailed information.</p>
                <a href="<?php echo e(route('reports.users.index')); ?>"
            ...
            <div class="bg-linier-to-br from-blue-50 to-blue-100 rounded-xl shadow-sm p-6 border border-blue-200">
                ...
                <p class="text-sm text-gray-600 mb-4">Generate PDF report of all events with complete event details and
                    statistics.</p>
                <a href="<?php echo e(route('reports.events.index')); ?>"
                    class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200 w-full justify-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
...
<?php endif; ?>
<?php /**PATH C:\Users\iafat\Herd\Acarra\resources\views/dashboard/home.blade.php ENDPATH**/ ?>