...
<div class="container mx-auto max-w-6xl px-4 py-6">
    <div class="text-sm text-gray-500 mb-6">
        <a href="<?php echo e(route('event.index')); ?>" class="hover:text-gray-700 hidden lg:flex items-center space-x-2 text-[20px] font-semibold">
        ...
        <div class="space-y-4 lg:col-start-3">
            <div class="relative w-full h-auto rounded-lg overflow-hidden shadow-xl">
                <?php if($event['image_path'] != null): ?>
                    <img src="<?php echo e(asset($event['image_path'])); ?>" alt="<?php echo e($event['title']); ?>" class="w-full h-full object-cover">
                <?php else: ?>
                    <img src="<?php echo e(asset('Image/Preview.jpg')); ?>" alt="<?php echo e($event['title']); ?>" class="w-full h-full object-cover">
                <?php endif; ?>
        ...
        <div class="lg:col-span-2 lg:col-start-1 lg:row-start-1">
            ...
            <div class="space-y-4 mb-8">
                ...
                <div class="flex items-center">
                    ...
                    <span class="font-semibold"><?php echo e($event['start_date_time']); ?> / <?php echo e($event['end_date_time']); ?></span>
                </div>
            </div>
            ...
            <div class="mt-6">
                <span class="inline-block bg-gray-200 text-gray-700 text-sm px-3 py-1 rounded-full"><?php echo e($event->category->name); ?></span>
            </div>
            <br>
            <h2 class="text-2xl font-bold text-gray-900 mb-3 border-b pb-2">
            ...
            <div class="text-gray-700 space-y-4">
                ...
                <div class="flex gap-5 items-center">
                    ...
                    <div>
                        <img src="<?php echo e(asset($registrant->user->profile_photo_path ?? 'https://ui-avatars.com/api/?name='.$registrant->user->name)); ?>" alt="" class="w-10 h-10 rounded-full flex items-center justify-center font-bold">
...
<?php endif; ?><?php /**PATH C:\Users\iafat\Herd\Acarra\resources\views/front-page/event/show.blade.php ENDPATH**/ ?>